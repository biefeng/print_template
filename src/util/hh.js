const PlainDraggable = function (t) {
  var e = {};
  ...
  var c = {
    add: function (t) {
      var e = void 0;
      return -1 === d(t) ? (o.push(e = {listener: t}), function (t) {
        e.event = t, u || s()
      }) : null
    }, remove: function (t) {
      var e;
    ...
    return f(t, [{
      ...
      key: "addStartHandler", value: function (t, e) {
        ...
        return v(t, "mousedown", this.startHandlers[e], {
          capture: !1,
          passive: !1
        }), v(t, "touchstart", this.startHandlers[e], {capture: !1, passive: !1}), v(t, "dragstart", g, {
          capture: !1,
          passive: !1
        }), e
      }
      ...
      key: "addMoveHandler", value: function (t, e) {
        ...
        v(t, "mousemove", r, {capture: !1, passive: !1}), v(t, "touchmove", r, {
          capture: !1,
          passive: !1
        }), n.curMoveHandler = e
      }
      ...
      key: "addEndHandler", value: function (t, e) {
        ...
        v(t, "mouseup", r, {capture: !1, passive: !1}), v(t, "touchend", r, {
          capture: !1,
          passive: !1
        }), n.curEndHandler = e
      }
  ...
  var P = {
    getName: k, getValue: function (t, e) {
      var n = void 0;
  ...
  X.ignoreNative = !0;
  var A = 9e3, F = 20, W = "tl", j = "both", R = "both", M = "containment", z = ["tl", "tr", "bl", "br"],
    N = ["start", "end"], V = ["inside", "outside"], G = [40, 200, 1e3], q = [100, 40, 0],
    ...
    Z = !U && !!document.uniqueID, $ = "MozAppearance" in document.documentElement.style,
    ...
    }, et = {}, nt = {}, rt = new y, ot = 0, it = void 0, at = void 0, lt = void 0, ut = void 0, st = void 0, dt = void 0,
    ct = void 0, ft = void 0, pt = void 0, vt = void 0,
    ht = K ? ["all-scroll", "move"] : ["grab", "all-scroll", "move"], mt = K ? "move" : ["grabbing", "move"],
    gt = "plain-draggable", yt = "plain-draggable-dragging", xt = "plain-draggable-moving", wt = {},
    ...
    St = window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.msCancelAnimationFrame || function (t) {
      ...
      ["x", "y"].forEach(function (e) {
        var n = Bt[e];
        if (n) {
          var r = t - n.lastFrameTime, o = Ot(Ct, e),
  ...
  function jt(t, e) {
    var n = {left: "x", right: "x", x: "x", width: "x", top: "y", bottom: "y", y: "y", height: "y"},
      r = {x: e.left, y: e.top}, o = {x: e.width, y: e.height};
  ...
  function Rt(t, e) {
    var n = t.getBoundingClientRect(), r = {left: n.left, top: n.top, width: n.width, height: n.height};
    if (r.left += window.pageXOffset, r.top += window.pageYOffset, e) {
      var o = window.getComputedStyle(t, ""), i = parseFloat(o.borderTopWidth) || 0,
        a = parseFloat(o.borderRightWidth) || 0, l = parseFloat(o.borderBottomWidth) || 0,
  ...
  function Zt(t) {
    ...
    var s = Rt(e), d = t.htmlOffset = {left: s.left ? -s.left : 0, top: s.top ? -s.top : 0};
  ...
  function $t(t) {
    var e = t.element, n = t.elementStyle, r = Rt(e),
      o = ["position", "marginTop", "marginRight", "marginBottom", "marginLeft", "width", "height"], i = n[ct];
    n[ct] = "none";
    var a = Rt(e);
    t.orgStyle ? o.forEach(function (e) {
      null != t.lastStyle[e] && n[e] !== t.lastStyle[e] || (n[e] = t.orgStyle[e])
    ...
    var u = Rt(e), s = t.htmlOffset = {left: u.left ? -u.left : 0, top: u.top ? -u.top : 0};
  ...
  function Jt(t) {
    ...
    n.setTranslate(0, 0);
    var i = t.svgOriginBBox = e.getBBox(), a = e.getBoundingClientRect(), l = Nt(t, a.left, a.top),
      u = t.svgOffset = {x: i.x - l.x, y: i.y - l.y}, s = Nt(t, r.left, r.top);
    return n.setTranslate(s.x + u.x - i.x, s.y + u.y - i.y), o
  }

  function Kt(t, e) {
    var n = Rt(document.documentElement), r = t.elementBBox = t.initElm(t),
    ...
    if (t.minLeft = o.left, t.maxLeft = o.right - r.width, t.minTop = o.top, t.maxTop = o.bottom - r.height, Ut(t, {
      ...
      var i = {x: r.width, y: r.height}, a = {x: t.minLeft, y: t.minTop}, l = {x: t.maxLeft, y: t.maxTop}, u = {
        left: "x",
        right: "x",
        x: "x",
        width: "x",
        ...
        var s = "containment" === e.base ? o : n, d = {x: s.left, y: s.top}, c = {x: s.width, y: s.height};
        ...
        function f(n) {
          if (null == n.center && (n.center = e.center), null == n.xGravity && (n.xGravity = e.gravity), null == n.yGravity && (n.yGravity = e.gravity), null != n.x && null != n.y) n.x = At(n.x, d.x, c.x), n.y = At(n.y, d.y, c.y), n.center && (n.x -= i.x / 2, n.y -= i.y / 2, n.corners = ["tl"]), (n.corners || e.corners).forEach(function (e) {
            ...
            if (r >= a.x && r <= l.x && o >= a.y && o <= l.y) {
              var u = {x: r, y: o}, s = r - n.xGravity, d = r + n.xGravity, c = o - n.yGravity, f = o + n.yGravity;
              s > a.x && (u.gravityXStart = s), d < l.x && (u.gravityXEnd = d), c > a.y && (u.gravityYStart = c), f < l.y && (u.gravityYEnd = f), t.push(u)
            }
          }); else {
            var r = null != n.x ? "x" : "y", o = "x" === r ? "y" : "x", u = o + "Start", s = o + "End",
              f = r + "Gravity", p = r.toUpperCase(), v = o.toUpperCase(), h = "gravity" + p + "Start",
              m = "gravity" + p + "End", g = "gravity" + v + "Start", y = "gravity" + v + "End";
        ...
        if ((p = e.element ? Rt(e.element) : null) || e.ppBBox) e.ppBBox && (p = jt(e.ppBBox, s)), p && e.edges.forEach(function (t) {
          ...
          f({xStart: i, xEnd: a, y: p.top, sides: [s], center: !1}), f({
            x: p.left,
            yStart: l,
            yEnd: u,
            sides: [s],
    ...
    if (c) {
      ...
      f ? t.autoScroll && (d.scrollWidth = t.autoScroll.scrollWidth, d.scrollHeight = t.autoScroll.scrollHeight) : (d.scrollWidth = p.scrollWidth, d.scrollHeight = p.scrollHeight), [["X", "Width", "left", "right"], ["Y", "Height", "top", "bottom"]].forEach(function (t) {
        var e = t[0], n = t[1], o = t[2], i = t[3], a = (d["scroll" + n] || 0) - p["client" + n], l = c["min" + e] || 0,
  ...
  function te(t, e) {
    ...
    if (null != e.snap) {
      var a = Q(e.snap) && null != e.snap.targets ? e.snap : {targets: e.snap}, l = [], u = i({targets: l}, a);
      ...
      var s = (Array.isArray(a.targets) ? a.targets : [a.targets]).reduce(function (t, e) {
        if (null == e) return t;
        var n = Dt(e), r = Ft(It(e)),
          o = n || r ? {boundingBox: e} : Q(e) && null == e.start && null == e.end && null == e.step ? e : {x: e, y: e},
          a = [], s = {}, d = o.boundingBox, c = void 0;
        if (n || Dt(d)) a.push({element: d}), s.boundingBox = d; else if (c = r || Ft(It(d))) a.push({ppBBox: c}), s.boundingBox = Wt(c); else {
          var f = void 0, p = ["x", "y"].reduce(function (t, e) {
            ...
            if (n = Yt(r)) t[e] = n, s[e] = Lt(n); else {
              ...
              Q(r) && (i = Yt(r.start), a = Yt(r.end), l = Yt(r.step), i && a && i.isRatio === a.isRatio && i.value >= a.value && (f = !0)), i = t[e + "Start"] = i || {
                value: 0,
                isRatio: !1
              }, a = t[e + "End"] = a || {value: 1, isRatio: !0}, s[e] = {
                start: Lt(i),
                end: Lt(a)
          ...
          p.xStart && !p.xStep && p.yStart && !p.yStep ? a.push({
            ...
            xEnd: p.xEnd,
            y: p.yStart
          }, {xStart: p.xStart, xEnd: p.xEnd, y: p.yEnd}, {x: p.xStart, yStart: p.yStart, yEnd: p.yEnd}, {
            x: p.xEnd,
            yStart: p.yStart,
            yEnd: p.yEnd
          }) : a.push(p)
    ...
    if (e.autoScroll) {
      var d = Q(e.autoScroll) ? e.autoScroll : {target: !0 === e.autoScroll ? window : e.autoScroll}, c = {};
    ...
    var v = {left: t.elementBBox.left, top: t.elementBBox.top}, h = void 0;
